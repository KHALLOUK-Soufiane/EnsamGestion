        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
                <form:form action="modifierEtudiant" method="post" modelAttribute="etudiant">
                <form:input type="hidden" class="form-control" path="id" value="${etudiantExistant.id}"/>
                  <div class="row">
                    <div class="col pr-1">
                      <div class="form-group">
                        <form:label path="code_apogee">Code apogee</form:label>
                        <form:input type="text" class="form-control" placeholder="Apogee" path="code_apogee" value="${etudiantExistant.code_apogee}"/>
                      </div>
                    </div>                  
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <form:input path="nom" type="text" class="form-control" placeholder="Nom..." value="${etudiantExistant.nom}"/>
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <form:label path="prenom">Prenom</form:label>
                        <form:input path="prenom" type="text" class="form-control" placeholder="Prenom..." value="${etudiantExistant.prenom}"/>
                      </div>
                    </div>
                  </div>
